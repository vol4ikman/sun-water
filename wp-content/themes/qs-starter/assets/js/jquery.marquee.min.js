		...
		return this.each(function () {
			var a = d.extend({}, d.fn.marquee.defaults, w),
				...
				g = {
					...
					destroy: function () {
						...
						b.css("visibility", "hidden").html(
							b.find(".js-marquee:first")
						);
						setTimeout(function () {
			...
			if ("string" === typeof w)
				...
				if (q) {
					...
					a.duration *=
						(parseInt(s, 10) + parseInt(m, 10)) / parseInt(m, 10);
				} else
					(h = b.find(".js-marquee:first").width() + a.gap),
						(k = b.width()),
						(a.duration *=
							(parseInt(h, 10) + parseInt(k, 10)) /
							parseInt(k, 10));
